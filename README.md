...
![GitHub Actions](https://github.com/seosite/protodep/actions/workflows/go.yml/badge.svg)
[![Language](https://img.shields.io/badge/language-go-brightgreen.svg?style=flat)](https://golang.org/)
[![issues](https://img.shields.io/github/issues/stormcat24/protodep.svg?style=flat)](https://github.com/seosite/protodep/issues?state=open)
[![License: Apache License 2.0](https://img.shields.io/badge/license-Apache2-orange.svg)](LICENSE)
[![GoDoc](https://godoc.org/github.com/seosite/protodep?status.png)](https://godoc.org/github.com/seosite/protodep)
...
```bash
$ go install -v github.com/seosite/protodep@v0.1.7
```
...
```bash
$ wget https://github.com/seosite/protodep/releases/download/0.1.4/protodep_darwin_amd64.tar.gz
...
[[dependencies]]
  target = "github.com/seosite/protodep/protobuf"
  branch = "master"
...
Apache License 2.0, see [LICENSE](https://github.com/seosite/protodep/blob/master/LICENSE).
